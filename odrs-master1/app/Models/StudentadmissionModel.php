...
class StudentadmissionModel extends Model
{
	...
	protected $allowedFields        = ['stud_admissionID', 'studID', 'sar_pupcct_resultID', 'f137ID', 'f138ID', 'psa_nsoID', 'good_moralID', 'medical_certID', 'picture_two_by_twoID', 'nc_non_enrollmentID', 'coc_hs_shsID', 'ac_pept_alsID', 'cert_dry_sealID', 'admission_status', 'created_at'];

	public function insertAdmissionStudents($userID, $sar_pupcct_resultID, $f137ID, $f138ID, $psa_nsoID, $good_moralID, $medical_certID, $picture_two_by_twoID, $nc_non_enrollmentID, $coc_hs_shsID, $ac_pept_alsID, $cert_dry_sealID, $admission_status)
	{	
	...
	public function updateAdmissionStudents($userID, $sar_pupcct_resultID, $f137ID, $f138ID, $psa_nsoID, $good_moralID, $medical_certID, $picture_two_by_twoID, $nc_non_enrollmentID, $coc_hs_shsID, $ac_pept_alsID, $cert_dry_sealID, $admission_status)
	{	
		$this->set('sar_pupcct_resultID', $sar_pupcct_resultID);
		$this->set('f137ID', $f137ID);
		$this->set('f138ID', $f138ID);
